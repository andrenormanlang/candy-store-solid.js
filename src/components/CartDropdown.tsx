      ...
      <Show when={isOpen()}>
        <div class="cart-dropdown">
          <For each={cartItems.items}>
            {(item) => (
              <div class="cart-item flex justify-between items-center p-2 mb-2 bg-white rounded-lg shadow">
                <div class="flex items-center">
                  ...
                  <div class="flex flex-col items-start">
                    <div class="font-bold text-name-cart">{item.name}</div>
                    <div class="flex items-center mt-2">
                      <div class="quantity-control flex items-center">
                        <button class="quantity-btn">-</button>
                        <div class="quantity-display mx-2 text-sm">
                          {item.quantity}
                        </div>
                        <button class="quantity-btn">+</button>
                      </div>
                      <div class="mx-2 ml-3 mr-3 font-bold">
